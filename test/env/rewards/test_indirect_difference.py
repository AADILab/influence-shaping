...
class TestIndirectDifference(TestEnv):
    ...
    def get_two_rovers_two_uavs_two_pois_path_config(self):
        config = self.get_two_rovers_two_uavs_two_pois_config(self)
    ...
    def test_one_rover_one_uav_one_poi_a(self):
    ...
    def test_one_rover_one_uav_one_poi_b(self):
    ...
    def test_one_rover_one_uav_one_poi_c(self):
    ...
    def test_one_rover_one_uav_one_poi_d(self):
    ...
    def test_one_rover_one_uav_one_poi_e(self):
    ...
    def test_one_rover_one_uav_one_poi_f(self):
    ...
    def test_one_rover_one_uav_one_poi_path_a_Global(self):
    ...
    def test_one_rover_one_uav_one_poi_path_a_Difference(self):
        config = self.get_default_config()
        # Start rover and uav far away
        config['env']['agents']['rovers'][0]['position']['fixed'] = [50.0, 50.0]
        config['env']['agents']['uavs'][0]['position']['fixed'] = [50.0, 50.0]
    ...
    def test_one_rover_one_uav_one_poi_path_a_IndirectDifference(self):
        config = self.get_default_config()
        # Start rover and uav far away
        config['env']['agents']['rovers'][0]['position']['fixed'] = [50.0, 50.0]
        config['env']['agents']['uavs'][0]['position']['fixed'] = [50.0, 50.0]
    ...
    def test_one_rover_one_uav_one_poi_path_a_Mixed(self):
        config = self.get_default_config()
        # Start rover and uav far away
        config['env']['agents']['rovers'][0]['position']['fixed'] = [50.0, 50.0]
        config['env']['agents']['uavs'][0]['position']['fixed'] = [50.0, 50.0]
    ...
    def two_rovers_two_uavs_two_pois_path_a(self):
    ...
    def two_rovers_two_uavs_two_pois_path_b(self):
        '''Rovers and uavs start in the center
    ...
    def two_rovers_two_uavs_two_pois_path_c(self):
        ...
        for agent_config in config['env']['agents']['rovers']+config['env']['agents']['rovers']:
            agent_config['reward_type'] = 'IndirectDifference'
        expected_rewards_at_each_step = [
            # Initial setup. No reward
            [0.0, 0.0, 0.0, 0.0],
    ...
    def two_rovers_two_uavs_two_pois_path_d(self):
        ...
        expected_rewards_at_each_step = [
            ...
            # D-Indirect is 2.0 for the first uav because it gets credit for BOTH rovers
            [0.0, 0.0, 2.0, 0.0] 
        ]
        env = createEnv(config)
        self.assert_path_rewards(env, agent_paths, expected_rewards_at_each_step)
