...
if __name__ == "__main__":
    ...
    parser.add_argument('--any', help='flag to request any available nodes, overrides --cnv', action='store_true')
    args = parser.parse_args()

    write_sbatch_executables_cli(args.config_directory, args.out_directory, args.time, args.seperate_trials, args.cnv, args.any)
