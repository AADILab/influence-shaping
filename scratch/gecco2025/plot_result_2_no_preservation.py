...
fig.savefig(os.path.expanduser('~/influence-shaping/outfigs/gecco2025/experiment_2_no_preservation.png'))
fig.savefig(os.path.expanduser('~/influence-shaping/outfigs/gecco2025/experiment_2_no_preservation.svg'))
