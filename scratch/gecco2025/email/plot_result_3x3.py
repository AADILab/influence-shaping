...
comparison_dir = Path(os.path.expanduser('~/influence-shaping/results/01_05_2025/yabby/31_more_circles/3x3'))
...
ax.set_title("9 Rovers, Drones, and POIs", fontsize=18, fontweight='bold', fontname='Helvetica')
...
fig.savefig(os.path.expanduser('~/influence-shaping/outfigs/gecco2025/experiment_3x3_highres.png'), dpi=300)
fig.savefig(os.path.expanduser('~/influence-shaping/outfigs/gecco2025/experiment_3x3_highres.svg'))
