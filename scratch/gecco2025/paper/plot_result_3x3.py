...
fig.savefig(os.path.expanduser('~/influence-shaping/outfigs/gecco2025/experiment_3x3.png'), dpi=300)
fig.savefig(os.path.expanduser('~/influence-shaping/outfigs/gecco2025/experiment_3x3.svg'))
