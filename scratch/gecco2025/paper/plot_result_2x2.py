...
comparison_dir = Path(os.path.expanduser('~/influence-shaping/results/01_05_2025/yabby/31_more_circles/2x2'))
...
ax.set_title("4 Rovers, Drones, and POIs", fontsize=18, fontweight='bold', fontname='Helvetica')
...
fig.savefig(os.path.expanduser('~/influence-shaping/outfigs/gecco2025/experiment_2x2.png'), dpi=300)
fig.savefig(os.path.expanduser('~/influence-shaping/outfigs/gecco2025/experiment_2x2.svg'))
